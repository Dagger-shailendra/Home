...
final User user = new User('DAgger', AssetImage('lib/assets/my_profile.jpg'), [
  follower1,
  follower2,
  follower3
], [
...
User follower1 = new User('ex_reflex', AssetImage('lib/assets/follower3.jpeg'), [], [], [], [], true);
User follower2 = new User('mia_ji', AssetImage('lib/assets/follower2.jpg'), [], [], [], [], false);
User follower3 = new User('kim_k', AssetImage('lib/assets/their_profile.jpeg'), [], [], [], [], true);
User follower4 = new User('ex_force', AssetImage('lib/assets/profile3.png'), [], [], [], [], true);
User follower5 = new User('Ex_edvin', AssetImage('lib/assets/profile6.jpg'), [], [], [], [], true);
User follower6 = new User('Ex_king', AssetImage('lib/assets/profile4.png'), [], [], [], [], false);
List<Post> userPosts = [
  ...
  new Post(new AssetImage('lib/assets/photo4.jpg'), follower5, "How did I even take this photo??", DateTime.now(), [user, follower2, follower3, follower4, follower5], [
    ...
    new Comment(follower1, "butter!", DateTime.now(), false),
    new Comment(user, " rite!", DateTime.now(), false),
    new Comment(follower5, "K", DateTime.now(), false)
  ], false, false),
  new Post(new AssetImage('lib/assets/photo5.jpg'), follower3, "Found this in my backyard. \nThought I'd post it jk lol lol lolol", DateTime.now(), [user, follower2, follower3, follower4, follower5], [
    new Comment(follower3, "K!", DateTime.now(), false),
    new Comment(follower1, "K \nbutter!", DateTime.now(), false),
    new Comment(user, "K", DateTime.now(), false),
    new Comment(follower5, "K", DateTime.now(), false)
  ], false, false),
  new Post(new AssetImage('lib/assets/photo5.jpg'), follower3, "Found this in my backyard. \nThought I'd post it jk lol lol lolol", DateTime.now(), [user, follower2, follower3, follower4, follower5], [
    new Comment(follower3, "cool!", DateTime.now(), false),
    new Comment(follower1, "butter!", DateTime.now(), false),
    new Comment(user, " rite!", DateTime.now(), false),
    new Comment(follower5, "batman", DateTime.now(), false)
  ], false, false),
  new Post(new AssetImage('lib/assets/photo5.jpg'), follower3, "Found this in my backyard. \nThought I'd post it jk lol lol lolol", DateTime.now(), [user, follower2, follower3, follower4, follower5], [
    new Comment(follower3, " cool!", DateTime.now(), false),
    new Comment(follower1, "butter!", DateTime.now(), false),
