...
import 'package:new_hoe/models/post.dart';
import 'package:new_hoe/models/user.dart';
import 'package:new_hoe/models/comment.dart';
import 'package:new_hoe/models/global.dart';
import 'package:new_hoe/main.dart';
import 'package:new_hoe/models/appbar.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  Widget getMain() {
    return Scaffold(
      appBar: AppBar(
        elevation: 1,
        title: Text("Fusion", style: textStyleBold),
